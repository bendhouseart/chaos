...
void main()
{
	...
	double xy,yy,vxy,vyy;
	double hy,yi,yf,d0;
	double k1xy, k1yy, k1vxy, k1vyy;
	double k2xy, k2yy, k2vxy, k2vyy;
	double k3xy, k3yy, k3vxy, k3vyy;
	double k4xy, k4yy, k4vxy, k4vyy;
	int tfi,taui;
	double  conditional,k;

	double xout,dumxy;
	double vxout,dumvxy,dt;
	double loggy,d0test, tempxy,tempvxy;
	int  counter;
